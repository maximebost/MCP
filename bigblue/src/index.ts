...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
  ...
  try {
    if (name === "get-product") {
      ...
      const productText = await makeBigblueAPIRequest<string>(productURL, productBody);
...
async function makeBigblueAPIRequest<T>(url: string, body: string): Promise<string | null> {
  try {
